...
% dann folgende Zeile auskommentieren.
% Symbolverzeichnis deaktiviert, die Formelzeichen werden im Text erklaert.
% Zum Reaktivieren die folgenden vier Zeilen einkommentieren.
...
% Glossar
%-----------------------------------
% Glossar deaktiviert, es enthielt nur die Beispieleintraege der Vorlage.
% Zum Reaktivieren die beiden folgenden Zeilen einkommentieren.
...
% Apendix / Anhang
%-----------------------------------
% Anhang deaktiviert. Zum Reaktivieren den Block einkommentieren und
% kapitel/anhang/anhang.tex mit eigenen Inhalten fuellen.
%\newpage
